            ...
            return (
              ...
              >
                ...
                <div className="p-3 text-center space-y-2">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto rounded-2xl overflow-hidden border border-cyan-400/50 shadow-md group-hover:scale-105 transition-transform bg-black">
